...
const _2 = () => {
    const d = [
        ...
        },
        {
          ...
          title: "Still here?",
          description:
            "Alright grass-toucher. Guess it's time to teach you how to buy $PAWSE. Don't say we didn't warn you and prepare ETH.",
        },
        {
          img: "/img/bear3.webp",
          title: "Go to Uniswap",
          description:
            "Now that you have some Solana, head to app.uniswap.org to be able to swap your ETH for some $PAWSE.",
        },
        {
          img: "/img/bear4.webp",
          title: "Buy $PAWSE",
      ...
      et.jsx("div", {
        ...
        children: et.jsx("div", {
          ...
          children: et.jsx("div", {
            ...
            children:
              "A gentle, cozy feeling that's like a snuggly blanket wrapped around your soul. To PAWSE is to melt into a state of pure chill where everything is soft and easy."
                .split("")
                .map((s, o) =>
                  et.jsxs(et.Fragment, {
                    children: [
